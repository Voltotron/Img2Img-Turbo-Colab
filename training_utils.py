...
def parse_args_paired_training(input_args=None):
   ...
   """
    ...
    #added args
    parser.add_argument('--num_patches', type=int, default=16, help="Number of patches used in LPIPS loss computation")
    parser.add_argument('--lambda_disc_complete', type=float, default=1.0, help="Weight for discriminator complete loss")
    parser.add_argument('--no_diffaug', action='store_true', help="Disable DiffAug")
